export namespace CentrifugeSource {
	...
	export const pressureHydrocycloneTable: PressureHydrocycloneTable[] = [
		{ label: 'ГЦ-150К', value: 0.15, mark: 'ГЦ-150К', diameter: 0.15, diameterInPipe: 0.05, hugestParticular: {min: 28, max: 95},
			...
			cylinderHeight: [2 * 0.15, 4 * 0.15], deltaP: 0.1875, iri: 'http://tonya-diploma.com/device/centrifuge/pressure/GC150K'},
		{ label: 'ГЦ-250К', value: 0.25, mark: 'ГЦ-250К', diameter: 0.25, diameterInPipe: 0.08, hugestParticular: {min: 37, max: 135},
			...
			cylinderHeight: [2 * 0.25, 4 * 0.25], deltaP: 0.2, iri: 'http://tonya-diploma.com/device/centrifuge/pressure/GC250K'},
		{ label: 'ГЦ-350К', value: 0.35, mark: 'ГЦ-350К', diameter: 0.35, diameterInPipe: 0.1, hugestParticular: {min: 44, max: 180},
			...
			cylinderHeight: [2 * 0.35, 4 * 0.35], deltaP: 0.25, iri: 'http://tonya-diploma.com/device/centrifuge/pressure/GC350K'},
		{ label: 'ГЦ-500К', value: 0.5, mark: 'ГЦ-500К', diameter: 0.5, diameterInPipe: 0.15, hugestParticular: {min: 52, max: 240},
			...
			cylinderHeight: [2 * 0.5, 4 * 0.5], deltaP: 0.3, iri: 'http://tonya-diploma.com/device/centrifuge/pressure/GC500K'},
		{ label: 'ГЦ-710К', value: 0.71, mark: 'ГЦ-710К', diameter: 0.71, diameterInPipe: 0.15, hugestParticular: {min: 86, max: 295},
			...
			cylinderHeight: [2 * 0.71, 4 * 0.71], deltaP: 0.1, iri: 'http://tonya-diploma.com/device/centrifuge/pressure/GC710K'},
		{ label: 'ГЦ-1000К', value: 1, mark: 'ГЦ-1000К', diameter: 1, diameterInPipe: 0.21, hugestParticular: {min: 115, max: 410},
			...
			cylinderHeight: [2, 4], deltaP: 0.1, iri: 'http://tonya-diploma.com/device/centrifuge/pressure/GC1000K'},
		{ label: 'ГЦ-1400К', value: 1.4, mark: 'ГЦ-1400К', diameter: 1.4, diameterInPipe: 0.3, hugestParticular: {min: 155, max: 570},
			...
			cylinderHeight: [2 * 1.4, 4 * 1.4], deltaP: 0.1, iri: 'http://tonya-diploma.com/device/centrifuge/pressure/GC1400K'},
		{ label: 'ГЦ-2000К', value: 2, mark: 'ГЦ-2000К', diameter: 2, diameterInPipe: 0.4, hugestParticular: {min: 215, max: 810},
			...
			cylinderHeight: [2 * 2, 4 * 2], deltaP: 0.1, iri: 'http://tonya-diploma.com/device/centrifuge/pressure/GC2000K'},
	];
	...
	export const centrifugeTableContinuous: CentrifugeTable[] = [
		{mark: '', rotorDiameter: undefined, separateFactor: undefined, rotorLength: undefined,
			rotorVolume: undefined, label: 'Выберите центрифугу', value: undefined, iri: ''},
		{mark: 'ОГШ-202К-03', rotorDiameter: 0.200, separateFactor: 4000, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-202К-03', value: 0.200, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH202K03'},
		{mark: 'ОГШ-321К-01', rotorDiameter: 0.320, separateFactor: 3231, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-321К-01', value: 0.320, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH321K05'},
		{mark: 'ОГШ-321К-05', rotorDiameter: 0.325, separateFactor: 2200, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-321К-05', value: 0.325, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH321K01'},
		{mark: 'ОГШ-352К-01', rotorDiameter: 0.350, separateFactor: 3535, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-352К-01', value: 0.350, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH352K01'},
		{mark: 'ОГШ-352К-05', rotorDiameter: 0.350, separateFactor: 3535, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-352К-05', value: 0.350, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH352K05'},
		{mark: 'ОГШ-352К-09', rotorDiameter: 0.350, separateFactor: 2500, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-352К-09', value: 0.350, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH352K09'},
		{mark: 'ОГШ-501К-06', rotorDiameter: 0.500, separateFactor: 2190, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-501К-06', value: 0.500, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH501K06'},
		{mark: 'ОГШ-501К-10', rotorDiameter: 0.500, separateFactor: 1960, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-501К-10', value: 0.500, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH501K10'},
		{mark: 'ОГШ-501К-11', rotorDiameter: 0.200, separateFactor: 2190, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-501К-11', value: 0.200, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH501K11'},
		{mark: 'ОГШ-631К-02', rotorDiameter: 0.630, separateFactor: 1420, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-631К-02', value: 0.630, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH631K02'},
		{mark: 'ОГШ-631К-06', rotorDiameter: 0.630, separateFactor: 2520, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-631К-06', value: 0.630, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH631K06'},
		{mark: 'ОГШ-802К-07', rotorDiameter: 0.800, separateFactor: 1530, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОГШ-802К-07', value: 0.800, iri: 'http://tonya-diploma.com/device/centrifuge/continuous/OGSH802K07'},
	];
	export const centrifugeTableDeterminate: CentrifugeTable[] = [
		...
		{mark: 'ОТР-102K-01', rotorDiameter: 0.105, separateFactor: 16940, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОТР-102K-01', value: 0.105, iri: 'http://tonya-diploma.com/device/centrifuge/determinate/OTR102K01'},
		{mark: 'ОТР-151K-01', rotorDiameter: 0.150, separateFactor: 15250, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОТР-151K-01', value: 0.150, iri: 'http://tonya-diploma.com/device/centrifuge/determinate/OTR151K01'},
		{mark: 'ОМБ-803К-03', rotorDiameter: 0.800, separateFactor: 1000, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОМБ-803К-03', value: 0.800, iri: 'http://tonya-diploma.com/device/centrifuge/determinate/OTR803K03'},
		{mark: 'ОМД-1202К-2', rotorDiameter: 1.200, separateFactor: 605, rotorLength: undefined,
			rotorVolume: undefined, label: 'ОМД-1202К-2', value: 1.200, iri: 'http://tonya-diploma.com/device/centrifuge/determinate/OTR1202K2'},
	];
