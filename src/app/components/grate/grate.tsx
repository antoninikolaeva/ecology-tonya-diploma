...
export class GrateComponent extends React.Component<GrateComponentProps, GrateComponentState> {
    ...
    private amountOfWasteGenerated = (value: number) => {
        ...
        let amountOfHammerCrushers = (amountOfWaste / currentHammerCrusher.performance) > 1 ?
    ...
    private grateCounting = () => {
        ...
        if (checkedSuitableGrates.length === 0) {
            this.setState({amountOfSuitableGrates, suitableGrates: checkedSuitableGrates,
    ...
    private selectWidthSection = (value: string | number) => {
        if (typeof value === 'number') {
            ...
            if (this.rodThicknessesRef) this.resetSelectToDefault(this.rodThicknessesRef, this.rodThicknessList); 
